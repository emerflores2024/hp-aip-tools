...
export default function InkReplenishment(props: any) {
    const subject = `HP All-In Plan Support: Your ink is on the way! - Case #${props.case_id}`;
            ...
            <div id="email_body" className="mt-7">
                ...
                <div className="w-full mt-5 px-5">
                    <p className="text-white text-justify">
                        Thank you for contacting us today. This email is just to inform you that we have successfully placed an order for new ink cartridge(s) for your printer. You can track your ink shipments by going to <a className="text-cyan-400" href="https://hpsmart.com">https://hpsmart.com</a> and sign in with your HP Account.
                    </p>
                    <br></br>
                    <p className="text-white text-justify">
